...
<%-- Récupération des valeurs --%>
    ...
    <% String valeur1 = tableauDeChiffres[0]; %>
    ...
    <% String valeur2_1 = tableauDeChiffres[0]; %>
    <% String valeur2_2 = tableauDeChiffres[1]; %>
    ...
    <% double valeurPlusProcheDe0 = Double.parseDouble(tableauDeChiffres[0]); %>
